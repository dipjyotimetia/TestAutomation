...
var BasePage = function() {
  ...
  this.IgnoreSynchronization=function(){
    browser.ignoreSynchronization=true;   //its working on non angularpages
  };

  //Function to click on a particular object
  this.Click=function(locator,object){
    element(by.locator(object)).click();
  };

  // FUnction to get the inner text of a particular object
  this.GetText=function(locator,object){
    var value;
    element(by.locator(object)).getText();
    return value;
  };

  // Function to write data
  this.Enter=function(locator,object,data){
    element(by.locator(object)).sendKeys(data);
  };

  // Handle Promice
  this.GetTextPromice=function(locator,object){
    element(by.locator(object)).getText().then(function (val) {
